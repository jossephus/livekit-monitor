...
export default function RoomDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base font-medium uppercase tracking-[0.14em] text-muted-foreground">Room metadata</CardTitle>
        </CardHeader>
        <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p className="text-xs uppercase tracking-wider text-muted-foreground">SID</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-wider text-muted-foreground">Publishers</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-wider text-muted-foreground">Recording</p>
            <p className="text-sm">{room?.active_recording ? "Active" : "Inactive"}</p>
          </div>
          <div>
            <p className="text-xs uppercase tracking-wider text-muted-foreground">Max participants</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base font-medium uppercase tracking-[0.14em] text-muted-foreground">Participants</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
                          ...
                          <div className="space-y-2">
                            {tracks.length === 0 ? (
                              ...
                              tracks.map((track, index) => {
                                ...
                                return (
                                  <div key={`${track.sid ?? source}-${index}`} className="rounded-lg border border-border p-2 text-xs">
